...
<li class="nav-item">
<button class="nav-link active w-100 text-start" data-bs-toggle="pill" data-bs-target="#pane-dashboard">
<i class="fa-solid fa-gauge-high me-2"></i>Dashboard
</button>
</li>

<li class="nav-item">
<button class="nav-link w-100 text-start" data-bs-toggle="pill" data-bs-target="#pane-products">
<i class="fa-solid fa-boxes-stacked me-2"></i>Medicine Inventory
</button>
</li>

<li class="nav-item">
<button class="nav-link w-100 text-start" data-bs-toggle="pill" data-bs-target="#pane-stockout">
...
<a href="?export=dispensing&month=<?php echo date('m'); ?>&year=<?php echo date('Y'); ?>" class="btn btn-danger btn-sm">
...
<div class="tab-pane fade" id="pane-stockout">
...
<select name="medicine_key" class="form-select" required>
